...
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Baja Empleado</label>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                        	<select id="select" name="id_pedido" class="custom-select">
                        		<%for(int i = 0; i < pedidos.size(); i++){ %>
                        			<option value="<%= pedidos.get(i).getId_pedido() %>"> ID_PEDIDO: <%= pedidos.get(i).getId_pedido() %>, ID_CLIENTE: <%= pedidos.get(i).getId_cliente() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
                        ...
                        <div class="col-12">
                        	<select id="select" name="id_servicio" class="custom-select">
                        		<%for(int i = 0; i < servicios.size(); i++){ %>
                        			<option value="<%= servicios.get(i).getId_servicio() %>"> ID_SERVICIO: <%= servicios.get(i).getId_servicio() %>, ID_PEDIDO: <%= servicios.get(i).getId_pedido() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>

                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="nombreCliente" id="nombreCliente" placeholder="Nombre" value="" required/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="apellidoCliente" id="apellidoCliente" placeholder="Apellidos" value=""/>
                            </div>
                            <div class="form-group">
                                <input type="number" class="form-control" name="tlfCliente" id="tlfCliente" placeholder="Teléfono" value=""/>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" name="correoCliente" id="correoCliente" placeholder="Correo Electrónico" value=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="direccionCliente" id="direccionCliente" placeholder="Dirección" value=""/>
                            </div>
                            <div class="form-group">
                                <input type="text" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" class="form-control" name="durSuscripcion" id="durSuscripcion" placeholder="AAAA-MM-DD" value=""/>
                            </div>
                            ...
                            <div class="form-group">
                            <label for="select" class="col-4 col-form-label">Amazon Perteneciente</label>
                            <div class="col-8">
                                ...
                                <!--  <div class="dropdown">
    								<a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#">
      								<span id="selected">Amazon Perteneciente</span><span class="caret"></span></a>
  									<ul class="dropdown-menu">
  									<%/*for(int i = 0; i < amazons.size(); i++){ %>
    									<li class="input-option" data-value="<%= amazons.get(i).getId_amazon() %>" >
    									<img alt="" src=""> <%= amazons.get(i).getPais() %>
    										<input type="hidden" class="option" name="id_amazon" id="id_amazon" value="<%= amazons.get(i).getId_amazon() %>"/>

...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <link rel="stylesheet" type="text/css" href="recursos/css/amazonMain.css">
      ...
      <div class="row">
        <div class="col-md-4 col-xl-12">
          <div class="card mb-4 box-shadow">
            <div class="flex-xl-row d-xl-flex">
              <div class="col-xl-4">
                <img class="card-img-top img-product" src="recursos/images/productos/<%= productos.get(i).getId_producto() %>.jpg" style=" ">
              </div>
            <div class="col-xl-8">
            <div class="card-body">
              ...
              <p style="margin-left: 10px"><%= productos.get(i).getPrecio() %>$</p>
              <%}else if(controladorBD.dameAmazon(Integer.parseInt(id_amazon)).getPais().equalsIgnoreCase("Spain") || controladorBD.dameAmazon(Integer.parseInt(id_amazon)).getPais().equalsIgnoreCase("France")){ %>
              <p style="margin-left: 10px"><%= productos.get(i).getPrecio() %>€</p>
              <%}else if(controladorBD.dameAmazon(Integer.parseInt(id_amazon)).getPais().equalsIgnoreCase("United Kingdom")){ %>
              <p style="margin-left: 10px"><%= productos.get(i).getPrecio() %>£</p>
              <%} %>
            </div>
            <small class="text-muted text-center" style="margin-left: 10px"><%= productos.get(i).getEspecificaciones() %></small>
            </div>
            </div>
          </div>
          </div>

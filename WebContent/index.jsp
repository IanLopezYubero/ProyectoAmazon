	...
	<div class="container">
		<div class="row">
			<div class="col-12" align="center">
				<img src="recursos/images/logo/amazonlogo2.png" class="imagenLogo">
			</div>
		</div>
		<div class="row" align="center">
			...
			<div class="col-3">
				<a
					href="amazonMain.jsp?id_amazon=<%=amazons.get(i).getId_amazon()%>"><img
					src="recursos/images/paises/<%=amazons.get(i).getPais()%>.png"
					class="imagenPais"></a>
			</div>
			<%
				}

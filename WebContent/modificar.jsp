...
<body>
	...
	<form action="operaciones.jsp?tipo=modAmazon" method="post">
		<div class="form-group">
			<label>Pais Amazon</label> <input type="text" class="form-control"
				name="pais" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=amazon.getPais()%>"> <input
				type="hidden" class="form-control" name="id_amazon"
				id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
				value="<%=amazon.getId_amazon()%>">
		</div>
		...
		//MODIFICAR PROVEEDOR
			...
			for (int i = 0; i < proveedores.size(); i++) {
				if (proveedores.get(i).getId_proveedor() == id_proveedor) {
					proveedor = new Proveedor(proveedores.get(i).getId_proveedor(),
							proveedores.get(i).getNombreProveedor(), proveedores.get(i).getDireccion(),
							proveedores.get(i).getTlf(), proveedores.get(i).getCorreoProveedor());
				}
			}
	%>
	...
	<form action="operaciones.jsp?tipo=modProveedor" method="post">
		<div class="form-group">
			<label>Nombre del proveedor</label> <input type="text"
				class="form-control" name="nombreProveedor" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=proveedor.getNombreProveedor()%>">
		</div>
		<div class="form-group">
			<label>Direccion del Proveedor</label> <input type="text"
				class="form-control" name="direccionProveedor"
				id="exampleInputPassword1" placeholder=""
				value="<%=proveedor.getDireccion()%>">
		</div>
		<div class="form-group">
			<label>Teléfono del Proveedor</label> <input type="number"
				class="form-control" name="tlfProveedor" id="exampleInputPassword1"
				placeholder="" value="<%=proveedor.getTlf()%>">
		</div>
		<div class="form-group">
			<label>Correo del Proveedor</label> <input type="email"
				class="form-control" name="correoProveedor"
				id="exampleInputPassword1" placeholder=""
				value="<%=proveedor.getCorreoProveedor()%>"> <input
				type="hidden" class="form-control" name="id_proveedor"
				id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
		...
		//MODIFICACION EMPLEADO
			...
			for (int i = 0; i < empleados.size(); i++) {
				if (empleados.get(i).getDni().equalsIgnoreCase(dniEmpleado)) {
					empleado = new Empleado(empleados.get(i).getDni(), empleados.get(i).getNombreEmpleado(),
							empleados.get(i).getApellidoEmpleado(), empleados.get(i).getDireccion(),
							empleados.get(i).getTlf(), empleados.get(i).getId_amazon());
				}
			}
	%>
	...
	<form action="operaciones.jsp?tipo=modEmple" method="post">
		<div class="form-group">
			<label>DNI del empleado</label> <input type="text"
				class="form-control" name="dniEmpleado" placeholder=""
				value="<%=empleado.getDni()%>">
		</div>
		<div class="form-group">
			<label>Nombre del empleado</label> <input type="text"
				class="form-control" name="nombreEmpleado" placeholder=""
				value="<%=empleado.getNombreEmpleado()%>">
		</div>
		<div class="form-group">
			<label>Apellido(s) del empleado</label> <input type="text"
				class="form-control" name="apellidoEmpleado" placeholder=""
				value="<%=empleado.getApellidoEmpleado()%>">
		</div>
		<div class="form-group">
			<label>Dirección del empleado</label> <input type="text"
				class="form-control" name="direccionEmpleado" placeholder=""
				value="<%=empleado.getDireccion()%>">
		</div>
		<div class="form-group">
			<label>Teléfono del empleado</label> <input type="number"
				class="form-control" name="tlfEmpleado" placeholder=""
				value="<%=empleado.getTlf()%>">
		</div>
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Amazon de
				Trabajo</label>
			<div class="col-12">
		...
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Sección de
				Trabajo</label>
			<div class="col-12">
		...
		//MODIFICACION ALMACEN
			...
			for (int i = 0; i < almacenes.size(); i++) {
				if (almacenes.get(i).getId_almacen() == id_almacen) {
					almacen = new Almacen(almacenes.get(i).getId_almacen(), almacenes.get(i).getProvincia(),
							almacenes.get(i).getLocalidad(), almacenes.get(i).getId_amazon());
				}
			}
	%>
	<h1 align="center">Modificación Empleado</h1>
	...
	<form action="operaciones.jsp?tipo=modAlmacen" method="post">
		<div class="form-group">
			<label>Provincia del almacén</label> <input type="text"
				class="form-control" name="provinciaAlmacen" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=almacen.getProvincia()%>">
		</div>
		<div class="form-group">
			<label>Localidad del almacén</label> <input type="text"
				class="form-control" name="localidadAlmacen"
				id="exampleInputPassword1" placeholder=""
				value="<%=almacen.getLocalidad()%>"> <input type="hidden"
				class="form-control" name="id_almacen" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=almacen.getId_almacen()%>">
		</div>
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Amazon
				Perteneciente</label>
			<div class="col-12">
				<select id="select" name="id_amazon" class="custom-select">
					<%
	...
	<form action="operaciones.jsp?tipo=modSeccion" method="post">
		<div class="form-group">
			<label>Nombre de la Seccion</label> <input type="text"
				class="form-control" name="nombreSeccion" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=seccion.getNombreSeccion()%>"> <input
				type="hidden" class="form-control" name="id_seccion"
				id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
				value="<%=seccion.getId_seccion()%>">
		</div>
		...
		//MODIFICACION DEPARTAMENTO
			...
			for (int i = 0; i < departamentos.size(); i++) {
				if (departamentos.get(i).getId_departamento() == id_departamento) {
					depart = new Departamento(departamentos.get(i).getId_departamento(),
							departamentos.get(i).getNombreDepartamento());
				}
			}
	%>
	...
	<form action="operaciones.jsp?tipo=modDepart" method="post">
		<div class="form-group">
			<label>Nombre del Departamento</label> <input type="text"
				class="form-control" name="nomDepart" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=depart.getNombreDepartamento()%>"> <input
				type="hidden" class="form-control" name="id_departamento"
				id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
				value="<%=depart.getId_departamento()%>">
		</div>
		<div class="form-group form-check">
			<label for="select" class="col-12 col-form-label">Cambiar
				almacen</label>
			<div class="col-12">
		...
		//MODIFICACION PRODUCTO
			...
			for (int i = 0; i < productos.size(); i++) {
				if (productos.get(i).getId_producto() == id_producto) {
					product = new Producto(productos.get(i).getId_producto(), productos.get(i).getNombreProducto(),
							productos.get(i).getPaisProduccion(), productos.get(i).getPrecio(),
							productos.get(i).getMarca(), productos.get(i).getModelo(),
							productos.get(i).getEspecificaciones(), productos.get(i).getExistencias(),
							productos.get(i).getId_departamento());
				}
			}
	%>
	...
	<form action="operaciones.jsp?tipo=modProduct" method="post">
		<div class="form-group">
			<label>Pais Produccion</label> <input type="text"
				class="form-control" name="paisProd" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=product.getPaisProduccion()%>">
		</div>
		<div class="form-group">
			<label>Precio</label> <input type="number" class="form-control"
				name="precio" placeholder="" step="0.01" min="0" max="1000"
				value="<%=product.getPrecio()%>">
		</div>
		<div class="form-group">
			<label>Nombre del producto</label> <input type="text"
				class="form-control" name="nomProdu" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=product.getNombreProducto()%>">
		</div>
		<div class="form-group">
			<label>Marca</label> <input type="text" class="form-control"
				name="marca" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=product.getMarca()%>">
		</div>
		<div class="form-group">
			<label>Modelo</label> <input type="text" class="form-control"
				name="modelo" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=product.getModelo()%>">
		</div>
		<div class="form-group">
			<label>Especificaciones</label> <input type="text"
				class="form-control" name="especific" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=product.getEspecificaciones()%>">
		</div>
		<div class="form-group">
		...
		<div class="form-group form-check">
			<label for="select" class="col-12 col-form-label">Asignar
				departamento</label>
			<div class="col-12">
		...
		//MODIFICACION CLIENTE
			...
			for (int i = 0; i < clientes.size(); i++) {
				if (clientes.get(i).getId_cliente() == id_cliente) {
					cliente = new Cliente(clientes.get(i).getId_cliente(), clientes.get(i).getDireccion(),
							clientes.get(i).getNombreCliente(), clientes.get(i).getApellidoCliente(),
							clientes.get(i).getCorreoCliente(), clientes.get(i).getTlf(),
							clientes.get(i).getTipoSuscripcion(), clientes.get(i).getDuracionSuscripcion(),
							clientes.get(i).getId_amazon());
				}
			}
	%>
	<h1 align="center">Modificación Producto</h1>
	...
	<form action="operaciones.jsp?tipo=modCliente" method="post">
		<div class="form-group">
			<label>Nombre Cliente</label> <input type="text" class="form-control"
				name="nomClien" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=cliente.getNombreCliente()%>">
		</div>
		<div class="form-group">
			<label>Apellido(s) Cliente</label> <input type="text"
				class="form-control" name="apeClien" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=cliente.getApellidoCliente()%>">
		</div>
		<div class="form-group">
			<label>Tlf Cliente</label> <input type="text" class="form-control"
				name="tlfClien" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=cliente.getTlf()%>">
		</div>
		<div class="form-group">
			<label>Correo Cliente</label> <input type="text" class="form-control"
				name="correoClien" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=cliente.getCorreoCliente()%>">
		</div>
		<div class="form-group">
			<label>Dirección Cliente</label> <input type="text"
				class="form-control" name="direcClien" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=cliente.getDireccion()%>">
		</div>
		<div class="form-group">
			<label>Duración Suscripción Cliente</label> <input type="text"
				class="form-control" name="duracionSuscrip" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder="AAAA-MM-DD"
				value="<%=cliente.getDuracionSuscripcion()%>"
				pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
		</div>
		<input type="hidden" class="form-control" name="id_cliente"
			id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
			value="<%=cliente.getId_cliente()%>"> <input type="hidden"
			class="form-control" name="id_amazon" id="exampleInputEmail1"
			aria-describedby="emailHelp" placeholder=""
			value="<%=cliente.getId_amazon()%>">
		<div class="form-group">
		...
		//MODIFICACION PEDIDO
			...
			for (int i = 0; i < pedidos.size(); i++) {
				if (pedidos.get(i).getId_pedido() == id_pedido) {
					pedido = new Pedido(pedidos.get(i).getId_pedido(), pedidos.get(i).getFechaRealizada(),
							pedidos.get(i).getFechaEntregaPrevista(), pedidos.get(i).getFechaDespachada(),
							pedidos.get(i).getFechaEntregada(), pedidos.get(i).getEstadoPedido(),
							pedidos.get(i).getReview(), pedidos.get(i).getMonto(), pedidos.get(i).getGastosEnvio(),
							pedidos.get(i).getId_cliente());
				}
			}
	...
	<form action="operaciones.jsp?tipo=modPedido" method="post">
		<div class="form-group">
			<label>Fecha realizada</label> <input type="text"
				class="form-control" name="fechaRealizada" placeholder="YYYY-MM-DD"
				value="<%=pedido.getFechaRealizada()%>"
				pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
		</div>
		<div class="form-group">
			<label>Fecha entrega prevista</label> <input type="text"
				class="form-control" name="fechaEntrePrev" placeholder="YYYY-MM-DD"
				value="<%=pedido.getFechaEntregaPrevista()%>"
				pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
		</div>
		<div class="form-group">
			<label>Fecha Despachada</label> <input type="text"
				class="form-control" name="fechaDespachada" placeholder="YYYY-MM-DD"
				value="<%=pedido.getFechaDespachada()%>"
				pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
		</div>
		<div class="form-group">
			<label>Fecha Entregada</label> <input type="text"
				class="form-control" name="fechaEntregada" placeholder="YYYY-MM-DD"
				value="<%=pedido.getFechaEntregada()%>"
				pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))">
		</div>
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Estado del
				pedido</label>
			<div class="col-12">
				<select id="select" name="estadoPedido" class="custom-select">
					...
					<option value="Entregado con Retraso">Entregado con
						Retraso</option>
		...
		<div class="form-group">
			<label>Review cliente</label> <input type="text" class="form-control"
				name="review" id="exampleInputEmail1" aria-describedby="emailHelp"
				placeholder="" value="<%=pedido.getReview()%>">
		</div>
		<div class="form-group">
			<label>Monto del Pedido</label> <input type="number"
				class="form-control" name="monto" placeholder="" step="0.01" min="0"
				max="1000" value="<%=pedido.getMonto()%>">
		</div>
		<div class="form-group">
			<label>Gastos de envío</label> <input type="number"
				class="form-control" name="gastos" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder=""
				value="<%=pedido.getGastosEnvio()%>">

		</div>
		<input type="hidden" class="form-control" name="id_cliente"
			id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=""
			value="<%=pedido.getId_cliente()%>"> <input type="hidden"
			class="form-control" name="id_pedido" id="exampleInputEmail1"
			aria-describedby="emailHelp" placeholder=""
			value="<%=pedido.getId_pedido()%>">
		<button type="submit" class="btn btn-primary">Submit</button>
	</form>
	<%
		//MODIFICACION SERVICIO-POSTVENTA	
			...
			for (int i = 0; i < servicios.size(); i++) {
				if (servicios.get(i).getId_servicio() == id_servicio) {
					servicio = new Servicio_Postventa(servicios.get(i).getId_servicio(),
							servicios.get(i).getId_pedido(), servicios.get(i).getDni(),
							servicios.get(i).getTipoServicio(), servicios.get(i).getEstadoCaso());
	...
	<form action="operaciones.jsp?tipo=modServ" method="post">
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Tipo de
				Servicio</label>
			<div class="col-12">
		...
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Añadir a
				Empleado</label>
			<div class="col-12">
				<select id="select" name="dniEmple" class="custom-select">
					...
					%>
					<option value="<%=empleadosSeccion.get(i).getDni()%>">
						<%=empleadosSeccion.get(i).getNombreEmpleado()%></option>
					<%
						}
					%>
				</select>

...
<body>
	...
	<form action="operaciones.jsp?tipo=altaAmazon" method="post">
		<div class="form-group">
			<label for="exampleInputEmail1">Pais de Amazon</label> <input
				type="text" class="form-control" name="paisAmazon"
	...
	<form action="operaciones.jsp?tipo=altaAlmacen" method="post">
		...
		<div class="form-group form-check">
			<label for="select" class="col-12 col-form-label">Añadir
				departamento</label>
			<div class="col-12">
	...
	<form action="operaciones.jsp?tipo=altaPedido" method="post">
		...
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Cliente que
				compró</label>
			<div class="col-12">
		...
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Producto
				comprado</label>
			<div class="col-12">
	...
	<form action="operaciones.jsp?tipo=altaServc" method="post">
		...
		<div class="form-group">
			<label for="select" class="col-12 col-form-label">Pedido
				Afectado</label>
			<div class="col-12">

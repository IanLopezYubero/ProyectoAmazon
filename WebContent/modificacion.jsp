...
<form action="modificar.jsp?tipo=modAmazon" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Amazon</label>
                        <div class="col-12">
...
<form action="modificar.jsp?tipo=modProveedor" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Proveedor</label>
                        <div class="col-12">
                        	<select id="select" name="id_proveedor" class="custom-select">
                        		<%for(int i = 0; i < proveedores.size(); i++){ %>
                        			<option value="<%= proveedores.get(i).getId_proveedor() %>"> <%= proveedores.get(i).getNombreProveedor() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
...
<form action="modificar.jsp?tipo=modEmple" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Empleado</label>
                        <div class="col-12">
                        	<select id="select" name="dni" class="custom-select">
...
<h1 align="center">Modificación Almacén</h1>

<form action="modificar.jsp?tipo=modAlmacen" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Almacén</label>
                        <div class="col-12">
                        	<select id="select" name="id_almacen" class="custom-select">
                        		<%for(int i = 0; i < almacenes.size(); i++){ %>
                        			<option value="<%= almacenes.get(i).getId_almacen() %>"> <%= almacenes.get(i).getProvincia() %>, <%= almacenes.get(i).getLocalidad() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
...
<h1 align="center">Modificación Sección</h1>

<form action="modificar.jsp?tipo=modSeccion" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Sección</label>
                        <div class="col-12">
...
<form action="modificar.jsp?tipo=modDepart" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Departamento</label>
                        <div class="col-12">
...
<form action="modificar.jsp?tipo=modProduct" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Producto</label>
                        <div class="col-12">
                        	<select id="select" name="id_producto" class="custom-select">
                        		<%for(int i = 0; i < productos.size(); i++){ %>
                        			<option value="<%= productos.get(i).getId_producto() %>"> <%= productos.get(i).getMarca() %>, <%= productos.get(i).getModelo() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
...
<h1 align="center">Modificación Cliente</h1>

<form action="modificar.jsp?tipo=modCliente" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Cliente</label>
                        <div class="col-12">
                        	<select id="select" name="id_cliente" class="custom-select">
                        		<%for(int i = 0; i < clientes.size(); i++){ %>
                        			<option value="<%= clientes.get(i).getId_cliente() %>"> <%= clientes.get(i).getNombreCliente() %> <%= clientes.get(i).getApellidoCliente() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
...
<form action="modificar.jsp?tipo=modPedido" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Pedido</label>
                        <div class="col-12">
                        	<select id="select" name="id_pedido" class="custom-select">
                        		<%for(int i = 0; i < pedidos.size(); i++){ %>
                        			<option value="<%= pedidos.get(i).getId_pedido() %>">ID_CLIENTE: <%= pedidos.get(i).getId_cliente() %>, ID_PEDIDO: <%= pedidos.get(i).getId_pedido() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>
...
<form action="modificar.jsp?tipo=modServ" method="post">
<div class="form-group">
<label for="select" class="col-12 col-form-label">Selecciona Servicio-Postventa</label>
                        <div class="col-12">
                        	<select id="select" name="id_servicio" class="custom-select">
                        		<%for(int i = 0; i < servicios.size(); i++){ %>
                        			<option value="<%= servicios.get(i).getId_servicio() %>">ID_SERVICIO: <%= servicios.get(i).getId_servicio() %>, ID_PEDIDO: <%= pedidos.get(i).getId_pedido() %></option>
                        		<%} %>
                        	</select>
                        </div>
                        </div>

		...
		<div class="form-group">
			...
			<div class="col-12">
				<select id="select" name="id_pedido" class="custom-select">
					...
					%>
					<option value="<%=pedidos.get(i).getId_pedido()%>">ID_CLIENTE:
						<%=pedidos.get(i).getId_cliente()%>, ID_PEDIDO:
		...
		<div class="form-group">
			...
			<div class="col-12">
				<select id="select" name="id_servicio" class="custom-select">
					...
					%>
					<option value="<%=servicios.get(i).getId_servicio()%>">ID_SERVICIO:
